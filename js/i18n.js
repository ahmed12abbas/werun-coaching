...
const STRINGS = {
  en: {
    ...
    aHistory: "This week",
    aNoPoints: "Nothing this week yet — check in at the next session and you're away.",
    aBoard: "The club",
  ...
  ar: {
    ...
    aHistory: "هذا الأسبوع",
    aNoPoints: "لا شيء هذا الأسبوع بعد — سجل حضورك في التمارين القادمة وابدأ.",
    aBoard: "النادي",
