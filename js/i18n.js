...
const STRINGS = {
  en: {
    ...
    aStravaHint: "Apple Watch or Samsung? Turn on their sync to Strava and your runs come through too.",
    aMileage: "My weekly mileage",
    aMileageEmpty: "Connect Strava, COROS or Intervals.icu in Settings and the kilometres you run this week show up here.",
    aMileageGo: "Connect an app",
    aApps: "Connect my apps",
    aConnected: "Connected",
    aStravaId: "Strava athlete number",
    aStravaIdPh: "e.g. 47583488",
    aStravaIdHint: "The number at the end of your Strava profile link. It puts a Strava button beside your name on your card.",
    aStravaShow: "Show my Strava on my card",
    aStravaConnect: "Connect Strava",
    aStravaNone: "Connected — nothing logged yet this week.",
    aStravaDisconnect: "Disconnect",
    aCorosConnect: "Connect COROS",
    aIntervalsConnect: "Connect Intervals.icu",
    aVoid: "Void",
    ...
    aWorth: "Worth",
    aCoach: "Coach",
    aRoleAthlete: "Athlete",
    aRoleCoach: "Coach",
    aRoleLeader: "Leader",
    aSearch: "Find a runner",
    aSearchPh: "Type a name",
    aSearchNone: "Nobody by that name.",
    ...
    aGreetMorning: "Good morning, {name}",
    aGreetAfternoon: "Good afternoon, {name}",
    aGreetEvening: "Good evening, {name}",
  ...
  ar: {
    ...
    aYourPoints: "نقاطك",
    aStreak: "ستريك",
    aSessionsCount: "التمارين",
    aHistory: "من أين جاءت",
    aNoPoints: "لا نقاط بعد — سجل حضورك في التمارين القادمة وابدأ.",
    aBoard: "النادي",
    ...
    aStravaHint: "عندك ساعة أبل أو سامسونج؟ فعّل مزامنتها مع سترافا ويوصل جريك هنا بعد.",
    aMileage: "مسافتي هالأسبوع",
    aMileageEmpty: "اربط سترافا أو كوروس أو Intervals.icu من الإعدادات وتطلع كيلومترات جريك هالأسبوع هنا.",
    aMileageGo: "اربط تطبيق",
    aApps: "ربط تطبيقاتي",
    aConnected: "متصل",
    aStravaId: "رقم حسابك في سترافا",
    aStravaIdPh: "مثلاً 47583488",
    aStravaIdHint: "الرقم اللي في آخر رابط ملفك في سترافا. يحط زر سترافا جنب اسمك على بطاقتك.",
    aStravaShow: "أظهر سترافا على بطاقتي",
    aStravaConnect: "ربط سترافا",
    aStravaNone: "متصل — ما فيه جري مسجّل هالأسبوع بعد.",
    aStravaDisconnect: "فصل الربط",
    aCorosConnect: "ربط كوروس",
    aIntervalsConnect: "ربط Intervals.icu",
    aVoid: "إلغاء",
    ...
    aRoleCoach: "مدرب",
    aRoleLeader: "قائد",
    aSearch: "ابحث عن عدّاء",
    aSearchPh: "اكتب الاسم",
    aSearchNone: "لا يوجد أحد بهذا الاسم.",
    aWithCoach: "مع {name}",
    aSteps: "خطوات",
    aTellUs: "كيف أداؤنا؟",
    ...
    aGreetMorning: "صباح الخير، {name}",
    aGreetAfternoon: "مساء الخير، {name}",
    aGreetEvening: "مساء الخير، {name}",
