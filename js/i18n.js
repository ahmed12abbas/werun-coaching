...
const STRINGS = {
  en: {
    ...
    buildLead: "Build it once, send one link. Anyone who opens it can get it onto a Garmin or Apple Watch.",
    ...
    pcMinutes: "Minutes",
    pcSeconds: "Seconds",
    pcOutside: "Outside the chart — showing the nearest row.",
    pcThatIs5k: "About a {time} 5K.",
    pcThatIsMile: "About a {time} mile.",
    pcFoot: "From the WE RUN pace chart — use these for the run steps above.",
    pc5k: "5K",
    pc10k: "10K",
    pcTempo: "Tempo",
    pcHm: "Half",
  ...
  ar: {
    ...
    buildLead: "ابنِها مرة واحدة وأرسل رابطًا واحدًا. من يفتحه ينقلها إلى ساعة جارمن أو آبل.",
    ...
    pcMinutes: "الدقائق",
    pcSeconds: "الثواني",
    pcOutside: "خارج الجدول — هذه أقرب نتيجة.",
    pcThatIs5k: "أي ٥ كم في {time} تقريبًا.",
    pcThatIsMile: "أي ميل في {time} تقريبًا.",
    pcFoot: "من جدول بيس WE RUN — استخدمه في خطوات الجري بالأعلى.",
    pc5k: "٥ كم",
    pc10k: "١٠ كم",
    pcTempo: "تيمبو",
    pcHm: "نصف ماراثون",
