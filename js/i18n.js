...
const STRINGS = {
  en: {
    ...
    aStravaHint: "See your last activity here.",
    aStravaConnect: "Connect Strava",
    aPullRefresh: "Pull to refresh",
    aPullRelease: "Release to refresh",
    aPullRefreshing: "Refreshing…",
    aStravaNone: "Connected — nothing logged yet.",
  ...
  ar: {
    ...
    aStravaHint: "شوف آخر نشاط لك هنا.",
    aStravaConnect: "ربط سترافا",
    aPullRefresh: "اسحب للتحديث",
    aPullRelease: "حرر للتحديث",
    aPullRefreshing: "جارٍ التحديث…",
    aStravaNone: "متصل — ما فيه نشاط مسجّل بعد.",
