...
/* =========================================================================
   ...
   Drawn here, not downloaded. Twelve pictures would be a few hundred
   ...
   size and take the page's own colours in both themes — so a thirteenth
...
const Avatars = (function () {
  /* Everything faces right on a 64x64 field. The viewBox is wider on every
  ...
  function runner(o) {
    /* Leggings are a second stroke over the thigh only, so the leg below the
       knee stays bare and the shape still reads as a leg. */
    const leg = (d, thigh) =>
    ...
    return (
      ...
      limb("M33 26 43 29l2-5", o.skin, 4.6) +
      leg("M29 39 38 45l6-1", "M29 39 35.5 43.7") +
      "</svg>"
    );
  }
  ...
  const ART = {
    m1: runner({ skin: "#e8b58c", kit: "#e11d48", shorts: "#1f2937", style: "band" }),
    m2: runner({ skin: "#c98a5b", kit: "#2563eb", shorts: "#0f172a", style: "cap" }),
    m3: runner({ skin: "#8d5a34", kit: "#10b981", shorts: "#1f2937", style: "beard", hair: "#141110" }),
    f1: runner({ skin: "#e8b58c", kit: "#8851F4", shorts: "#3b2a63", style: "pony", tights: true }),
    f2: runner({ skin: "#c98a5b", kit: "#06b6d4", shorts: "#134e4a", style: "bun", tights: true }),
    f3: runner({ skin: "#8d5a34", kit: "#ec4899", shorts: "#4c1d3d", style: "long", hair: "#141110" }),
    cheetah: cheetah,
    horse: horse,
    hare: hare,
    formula: formula,
